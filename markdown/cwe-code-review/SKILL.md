...
- Provide a single minimal verbatim source code excerpt demonstrating the weakness enclosed in a fenced code block with the correct language identifier.
- For each vulnerable line, append the inline comment `VULNERABLE`.
